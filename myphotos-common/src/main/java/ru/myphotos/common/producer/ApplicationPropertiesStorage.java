...
public class ApplicationPropertiesStorage extends AbstractPropertiesLoader {
    ...
    private void postConstruct() {
        ...
        overrideApplicationProperties(applicationProperties, System.getenv(), "System environment");//переопределение существу. С систм. окружение
        overrideApplicationProperties(applicationProperties, System.getProperties(), "System properties");//переопределение существу. С систмых св-в
